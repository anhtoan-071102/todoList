...
class DefaultApi:
    ...
    def api_tasks_get(
        ...
        _param = self._api_tasks_get_serialize(
    ...
    @validate_call
    def api_tasks_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def api_tasks_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def api_tasks_id_delete(
        self,
        id: Annotated[StrictInt, Field(description="ID của nhiệm vụ")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: ID của nhiệm vụ (required)
        :type id: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._api_tasks_id_delete_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def api_tasks_id_delete_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID của nhiệm vụ")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_tasks_id_delete_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID của nhiệm vụ")],
        _request_timeout: Union[
            None,
    ...
    def _api_tasks_id_delete_serialize(
        self,
        id,
        _request_auth,
        _content_type,
    ...
    def api_tasks_id_get(
        ...
        _param = self._api_tasks_id_get_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def api_tasks_id_get_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="ID của nhiệm vụ")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_tasks_id_get_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="ID của nhiệm vụ")],
        _request_timeout: Union[
            None,
    ...
    def _api_tasks_id_get_serialize(
        self,
        id,
        _request_auth,
        _content_type,
